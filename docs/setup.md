...
1. クローンしたいリポジトリのURLを取得します。Githubを開いて、`code`->`HTTPS`->`URLをコピー`
    * SSH設定をしていない場合はHTTPSでもOK
   ![image](./images/gitclone_https.png)
   対象のURL：https://github.com/hrforcedsu/git_lesson
